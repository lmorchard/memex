 ...
 * Model loader helper
 *
 * see: http://github.com/weierophinney/bugapp/tree/master/application/controllers/helpers/GetForm.php
 */
class Memex_Helper_GetModel extends Zend_Controller_Action_Helper_Abstract
{
    /**
